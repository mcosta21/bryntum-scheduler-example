...
!(function (e, n) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? (exports.Nl = n())
        : ((e.bryntum = e.bryntum || {}), (e.bryntum.locales = e.bryntum.locales || {}), (e.bryntum.locales.Nl = n()));
})(window, function () {
    return (function (e) {
        var n = {};
        function t(r) {
                ...
                return (
                    ...
                    (r = [
                                ...
                                return (
                                    t.forEach(function (n) {
                                        Object.keys(n).forEach(function (t) {
                                            "object" === i(n[t]) ? (e[t] = a(a({}, e[t]), n[t])) : (e[t] = n[t]);
                                        });
                                    }),
                                    e
                                );
                        ...
                        },
                        {
                            ...
                            value: function (e, n) {
                                var t = function (n, t) {
                                    if (!e[n]) throw new Error('Key "'.concat(n, "\" doesn't exist in locale"));
                                    if (t) {
                                        if (!e[n][t]) throw new Error('SubKey "'.concat(n, ".").concat(t, "\" doesn't exist in locale"));
                                        delete e[n][t];
                                    } else delete e[n];
                                };
                        ...
                        },
                        {
                            key: "publishLocale",
                            value: function (e, n) {
                                var t = (window.bryntum = window.bryntum || {}),
                                    r = (t.locales = t.locales || {});
                                r[e] = r[e] ? this.mergeLocales(r[e], n) : n;
                            },
                        },
                    ]),
                    (t = null) && l(n.prototype, t),
                    r && l(n, r),
                    e
                );
            })();
        ...
        function (e, n, t) {
            ...
            var r = {
                    ...
                    Object: { Yes: "Ja", No: "Nee", Cancel: "Annuleren" },
                    Combo: { noResults: "Geen resultaten" },
                    FilePicker: { file: "Vijl" },
                    Field: {
                        badInput: "Ongeldige veldwaarde",
                        patternMismatch: "Waarde moet overeenkomen met een specifiek patroon",
                        rangeOverflow: function (e) {
                            return "Waarde moet kleiner zijn dan of gelijk aan ".concat(e.max);
                        },
                        rangeUnderflow: function (e) {
                            return "Waarde moet groter zijn dan of gelijk aan ".concat(e.min);
                        },
                    ...
                    DateField: { invalidDate: "Ongeldige datuminvoer" },
                    NumberFormat: { locale: "nl", currency: "EUR" },
                    DurationField: { invalidUnit: "Ongeldige eenheid" },
                    TimeField: { invalidTime: "Ongeldige tijdsinvoer" },
                    List: { loading: "Laden..." },
                    PagingToolbar: {
                        ...
                        pageCountTemplate: function (e) {
                            return "van ".concat(e.lastPage);
                        },
                        summaryTemplate: function (e) {
                            return "Records ".concat(e.start, " - ").concat(e.end, " van ").concat(e.allCount, " worden weergegeven");
                        },
                    },
                    DateHelper: {
                        locale: "nl",
                        ...
                        unitAbbreviations: [["mil"], ["s", "sec"], ["m", "min"], ["u"], ["d"], ["w", "wk"], ["ma", "mnd", "m"], ["k", "kwar", "kwt", "kw"], ["j", "jr"]],
                ...
                a = t(0),
                o = a.a.mergeLocales(r, {
                    ColumnPicker: { column: "Kolom", columnsMenu: "Kolommen", hideColumn: "Verberg Kolom", hideColumnShort: "Verberg" },
                    Filter: {
                    ...
                    FilterBar: { enableFilterBar: "Maak filterbalk zichtbaar", disableFilterBar: "Verberg filterbalk" },
                    Group: {
                        group: "Groepeer",
                    ...
                    Search: { searchForValue: "Zoek op term" },
                    Sort: {
                        sort: "Sorteer",
                    ...
                    GridBase: {
                        ...
                        moveColumnTo: function (e) {
                            return "Kolom verplaatsen naar ".concat(e);
                        },
                    },
                    CellMenu: { removeRow: "Verwijder rij", removeRows: "Verwijder rijen" },
                    PdfExport: { "Waiting for response from server": "Wachten op antwoord van server...", "Export failed": "Export mislukt", "Server error": "Serverfout", "Generating pages": "Pagina's genereren..." },
                    ExportDialog: {
                        width: "40em",
                        labelWidth: "12em",
                    ...
                    ExportRowsCombo: { all: "Alle rijen", visible: "Zichtbare rijen" },
                    ExportOrientationCombo: { portrait: "Staand", landscape: "Liggend" },
                    SinglePageExporter: { singlepage: "Enkele pagina" },
                    MultiPageExporter: {
                        multipage: "Meerdere pagina's",
                        exportingPage: function (e) {
                            var n = e.currentPage,
                                t = e.totalPages;
                            return "Exporteren van de pagina ".concat(n, "/").concat(t);
                        },
                    },
                ...
                i = a.a.mergeLocales(o, {
                    ResourceInfoColumn: {
                        eventCountText: function (e) {
                            return e + " evenement" + (1 !== e ? "en" : "");
                        },
                    },
                    Dependencies: { from: "Van", to: "Naar", valid: "Geldig", invalid: "Ongeldig" },
                    DependencyType: {
                        SS: "GB",
                        SF: "BE",
                        FS: "EB",
                    ...
                    EventEdit: { Name: "Naam", Resource: "Resource", Start: "Start", End: "Eind", Save: "Bewaar", Delete: "Verwijder", Cancel: "Annuleer", "Edit event": "Wijzig item", Repeat: "Herhaal" },
                    DependencyEdit: {
                        From: "Van",
                        To: "Tot",
                        Type: "Type",
                    ...
                    EventDrag: { eventOverlapsExisting: "Gebeurtenis overlapt bestaande gebeurtenis voor deze bron", noDropOutsideTimeline: "Evenement kan niet volledig buiten de tijdlijn worden verwijderd" },
                    SchedulerBase: { "Add event": "Voeg evenement toe", "Delete event": "Verwijder item", "Unassign event": "Gebeurtenis ongedaan maken" },
                    HeaderContextMenu: { pickZoomLevel: "Zoom in", activeDateRange: "Datum bereik", startText: "Start datum", endText: "Eind datum", todayText: "Vandaag" },
                    TimeAxisHeaderMenu: { pickZoomLevel: "Zoom in", activeDateRange: "Datum bereik", startText: "Start datum", endText: "Eind datum", todayText: "Vandaag" },
                    UndoRedo: { UndoLastAction: "Maak de laatste actie ongedaan", RedoLastAction: "Herhaal de laatste ongedaan gemaakte actie" },
                    EventFilter: { filterEvents: "Filter items", byName: "Op naam" },
                    TimeRanges: { showCurrentTimeLine: "Maak huidige tijdlijn zichtbaar" },
                    PresetManager: { minuteAndHour: { topDateFormat: "ddd DD-MM, hh" }, hourAndDay: { topDateFormat: "ddd DD-MM" }, weekAndDay: { displayDateFormat: "hh:mm" } },
                    ...
                    RecurrenceLegend: {
                        ...
                        "Weekly on {1}": function (e) {
                            var n = e.days;
                            return "Wekelijks op ".concat(n);
                        },
                        "Monthly on {1}": function (e) {
                            var n = e.days;
                            return "Maandelijks op ".concat(n);
                        },
                        "Yearly on {1} of {2}": function (e) {
                            var n = e.days,
                                t = e.months;
                            return "Jaarlijks op ".concat(n, " ").concat(t);
                        },
                        "Every {0} days": function (e) {
                            var n = e.interval;
                            return "Elke ".concat(n, " dagen");
                        },
                        "Every {0} weeks on {1}": function (e) {
                            var n = e.interval,
                                t = e.days;
                            return "Elke ".concat(n, " weken op ").concat(t);
                        },
                        "Every {0} months on {1}": function (e) {
                            var n = e.interval,
                                t = e.days;
                            return "Elke ".concat(n, " maanden in ").concat(t);
                        },
                        "Every {0} years on {1} of {2}": function (e) {
                            var n = e.interval,
                                t = e.days,
                                r = e.months;
                            return "Elke ".concat(n, " jaar op ").concat(t, " ").concat(r);
                        },
                        position1: "de eerste",
                        position2: "de tweede",
                        position3: "de derde",
                    ...
                    RecurrenceDaysCombo: { day: "dag", weekday: "weekdag", "weekend day": "weekend dag" },
                    RecurrencePositionsCombo: { position1: "eerste", position2: "tweede", position3: "derde", position4: "vierde", position5: "vijfde", "position-1": "laatste" },
                    RecurrenceStopConditionCombo: { Never: "Nooit", After: "Na", "On date": "Op datum" },
                    RecurrenceFrequencyCombo: { Daily: "Dagelijks", Weekly: "Wekelijks", Monthly: "Maandelijks", Yearly: "Jaarlijks" },
                    RecurrenceCombo: { None: "Geen", Custom: "Aangepast..." },
                    Summary: {
                        "Summary for": function (e) {
                            return "Samenvatting voor ".concat(e);
                        },
                    },
                    ScheduleRangeCombo: { completeview: "Compleet schema", currentview: "Huidige weergave", daterange: "Periode", completedata: "Alle data (events)" },
                    SchedulerExportDialog: { "Schedule range": "Scheduler bereik", "Export from": "Vanaf", "Export to": "Naar" },
                    ExcelExporter: { "No resource assigned": "Geen resource toegewezen" },
                    CrudManagerView: { serverResponseLabel: "Server reactie:" },
                });
            n.default = i;
        },
    ]).default;
